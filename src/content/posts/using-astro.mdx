...
where I can talk about software, site reliability and computers. All the things I love, really.
...
And that's it, really. I try to reduce the amount of Javascript I send to the frontend. In future, as the number of posts grow, I may add searching and tagging for the posts but this website is meant to be as lightweight as possible.
